...
// URL ACTUALIZADA PARA SEPT_2 (Convertida a formato Embed)
const VIDEO_EMBED_URL = "https://iframe.mediadelivery.net/embed/547379/b8753503-9d63-44da-9909-b2faaacfe4c6?autoplay=true&muted=true&loop=true";

export default function LandingPageSept2() {
  const [videoExpanded, setVideoExpanded] = useState(false);
  const [isMuted, setIsMuted] = useState(true);

  useEffect(() => {
    // REGISTRO DE SALIDA: sept_2
    console.log("Track: Visita registrada desde origen -> sept_2");
    
    // Si usas Meta Pixel o Google Analytics, aquí dispararías el evento:
    // window.fbq('track', 'PageView', { landing: 'sept_2' });
    ...
    <div style={{ 
      ...
      <header style={{
        ...
        <div style={{ 
          ...
          <a href={HOME_URL} style={{ border: 'none', textDecoration: 'none' }}> 
            <img
      ...
      <div style={{
        ...
        {/* CONTENEDOR DE VIDEO ACTUALIZADO */}
        <div style={{
          width: '100%',
          maxWidth: '1150px',
          marginBottom: '50px',
        ...
        <div style={{
          ...
          <button 
            onClick={() => console.log("Clic en Opciones Legales - sept_2")}
